...
type ChallengeReset struct {
	// The ID of the Access Grant to change
	ID string `json:"ID,omitempty"`
	// a map of `tag:old,new` passwords to reset with, if one fails all fail
	Keys map[string]PChange `json:"Keys,omitempty"`
}
